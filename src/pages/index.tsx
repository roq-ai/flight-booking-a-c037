  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Flight Booking Application - Your gateway to effortless flight bookings, serving India & international destinations with top-notch service and convenience."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1436491865332-7a61a109cc05?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxmbGlnaHR8ZW58MHx8fHwxNjk4Mzk1MTc2fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Flight Booking Application - Your gateway to effortless flight bookings, serving India & international destinations with top-notch service and convenience.`}
            </Text>
            <Box
