...
import { useRoqPlatformUserProfiles, useCustomerServiceCount, useTravelAgentCount, useBookingCount } from 'lib/roq';

import { FlightListPage as ShowCaseList } from 'pages/flights';
...
function DashboardPage() {
  ...
  const travelAgentStat = useTravelAgentCount();
